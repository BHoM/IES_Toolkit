...
namespace BH.Engine.IES
{
    public static partial class Convert
    {
        ...
        public static string FromOpeningType(this OpeningType type, SettingsIES settings)
        {
            switch(type)
            {
        ...
        public static OpeningType ToOpeningType(this string iesOpeningType, SettingsIES settings)
        {
            if (iesOpeningType == "0")
